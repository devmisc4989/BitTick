        ...
        init: function (elem, options) {
            if (elem.nodeName.toLowerCase() === "textarea") {
               ...
               // var iframe = this.iframe = $("<iframe/>").height(textarea.height());
                var iframe = this.iframe = $("#textEditIframe").height(textarea.height());
                ...
                /*iframe[0].contentWindow.document.domain=BTeditorVars.DocDomain
                console.log(iframe[0].contentWindow.document);*/

                var That=this;
                setTimeout(function(){
                    priv.initEditor.call(That, opts);
                    priv.attachEditorEvents.call(That);
                    ...
                    if (opts.loaded) { opts.loaded.call(That); }
                }, 2500)
