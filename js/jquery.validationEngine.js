...
(function($) {
    ...
    var methods = {
        ...
        _validateField: function(field, options, skipAjaxValidation) {
                ...
                switch (rules[i]) {
                    ...
                    case "ajax":
						...
						if(!skipAjaxValidation){
							options.ajaxValidCache[fieldName] = false;
            ...
            if (options.isError){
				...
				if (!isAjaxValidator) 
				{
					...
					methods._handleStatusCssClasses(field, options.isError);
				}
			}
        ...
        _ajax: function(field, rules, i, options) {			
            ...
            if (!options.isError) {
                $.ajax({
                    ...
                    cache: false,
                    dataType: "json",
                    data: "fieldId=" + field.attr("id") + "&fieldValue=" + encodeURIComponent(field.attr("value")) + "&extraData=" + extraData,
                    field: field,
                    rule: rule,
                    methods: methods,
                    options: options,
                    ...
                    success: function(json) {
						...
						//check to see if all ajax fields are validated
						if(methods._checkAjaxStatus(options))
						{
							var autoSubmit = form.data('autoSubmit');
							if(autoSubmit && typeof(methods._onSubmitEvent)=='function')							
								methods._onSubmitEvent.call(field[0].form);
						}
						//reset autosubmit
        ...
        _showPrompt: function(field, promptText, type, ajaxed, options, ajaxform) {
			...
			methods._handleStatusCssClasses(field, type==''?true:false)
		...
		_handleStatusCssClasses: function(field, isError) {
        ...
        _saveOptions: function(form, options) {
			...
			{
				if( typeof($.validationEngineLanguage.newLang) == 'function' )
				{
