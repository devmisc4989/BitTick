 ...
 * Include Exceptions
 */
require_once BASEPATH . 'application/libraries/wurfldb/TeraWurflExceptions/TeraWurflExceptions.php';

if (!class_exists('TeraWurflConfig', false)) {
    @include_once BASEPATH . 'application/libraries/wurfldb/TeraWurflConfig.php';
    if (!class_exists('TeraWurflConfig', false)) {
        throw new TeraWurflException("Unable to load configuration file TeraWurflConfig.php.  ");
    }
}
/* * #@+
 * Include required files
 */
require_once BASEPATH . 'application/libraries/wurfldb/DatabaseConnectors/TeraWurflDatabase.php';
require_once BASEPATH . 'application/libraries/wurfldb/WurflConstants.php';
require_once BASEPATH . 'application/libraries/wurfldb/TeraWurflUtils/TeraWurflLoader.php';
require_once BASEPATH . 'application/libraries/wurfldb/UserAgentMatcherFactory.php';
require_once BASEPATH . 'application/libraries/wurfldb/UserAgentUtils.php';
require_once BASEPATH . 'application/libraries/wurfldb/WurflSupport.php';
require_once BASEPATH . 'application/libraries/wurfldb/UserAgentMatchers/UserAgentMatcher.php';
require_once BASEPATH . 'application/libraries/wurfldb/HttpHeaderNormalizers/IHttpHeaderNormalizer.php';
require_once BASEPATH . 'application/libraries/wurfldb/HttpHeaderNormalizers/GenericUserAgentNormalizer.php';
require_once BASEPATH . 'application/libraries/wurfldb/TeraWurflHttpRequest/TeraWurflHttpRequest.php';
require_once BASEPATH . 'application/libraries/wurfldb/VirtualCapability/VirtualCapabilityProvider.php';
/* * #@- */
...
class TeraWurfl {
     ...
     * @var string
     */
    public $release_version = "1.5.1.1";
    public $historical_release_version = "2.2.3";
    ...
    public function getDeviceCapabilitiesFromRequest($request_headers = null) {
        ...
        if (TeraWurflConfig::$SIMPLE_DESKTOP_ENGINE_ENABLE) {
            require_once BASEPATH . 'application/libraries/wurfldb/UserAgentMatchers/SimpleDesktopUserAgentMatcher.php';
    ...
    public function getFullCapabilities($deviceID) {
        ...
        if ($deviceID != WurflConstants::NO_MATCH && $this->db->db_implements_fallback) {
            ...
            foreach ($fallbackTree as $dev) {
                if (!is_array($dev))
                    throw new TeraWurflException("Invalid device in fallback tree for $deviceID");
                $fallbackIDs[] = $dev['id'];
    ...
    public function getDeviceCapability($capability) {
        if ($this->flat_capabilities === null)
            $this->flattenCapabilities();
