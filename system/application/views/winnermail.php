...
?>
<h1 style="font-family:Arial, Helvetica, sans-serif; font-size:26px; font-weight:bold; color:#111;"><?php echo sprintf($this->lang->line('emails_winner_headline'), $collectionname); ?></h1>
<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:normal; color:#555; line-height:22px;"><?php echo $this->lang->line('emails_salutation') . $clientname . ","; ?><br>
    <?php echo sprintf($this->lang->line('emails_winner_copy1'), $winnercr); ?></p>
<a href="<?php echo $winnerurl; ?>" style="font-family:Arial, Helvetica, sans-serif; color:<?php echo $link_color ?>; text-decoration:underline;"><?php echo $winnerurl; ?></a>
<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:normal; color:#555; line-height:22px;"><?php echo sprintf($this->lang->line('emails_winner_copy2'), $controlcr, $uplift, $visitorcount); ?></p>
