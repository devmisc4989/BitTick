...
?>
<div id="inner_bg">
    <form name="signupform" id="signupform" method="post" action="<?php echo $basesslurl; ?>users/signup">
        <div id="signup_container">
            <div class="signup-left">
                <div class="signup-left-top"></div>
                <div class="signup-left-mdle">
                ...
                <div class="signup-left-btm"></div>
            </div>
            <input type="hidden" id="path" name="path" value="<?php echo $baseurl; ?>"/>
            <div class="signup-right">
                <div class="thanks">
                    <h1><?php echo $this->lang->line('signup_thankshead'); ?><br />
                        <span><?php echo $this->lang->line('signup_thanksspan'); ?></span></h1>
                </div>
                <p><?php echo $this->lang->line('signup_thanksdescription'); ?> </p>
                <ul>
                    <li>
                        <h1><?php echo $this->lang->line('signup_totaluser'); ?></h1>
                        <h4><?php echo $this->lang->line('signup_everyweek'); ?></h4>
                    </li>
                    <li>
                        <h1><?php echo $this->lang->line('signup_secure'); ?></h1>
                        <h4><?php echo $this->lang->line('signup_securedescription'); ?></h4>
                    </li>
                </ul>
            </div>
        </div>
...
<div style="display:none;">
    <div class="confirmation confirmation-user" style="height:610px; width:780px;" id="terms">
        <div class="confirmation align-left"  style="height:580px;overflow:scroll; overflow-x: auto; padding:20px 0 0 0; width:790px">
            <div>
